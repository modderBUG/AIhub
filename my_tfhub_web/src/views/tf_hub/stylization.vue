    ...
    <div class="upload-form">
      <div class="upload-item">
        <el-upload
          ...
          :action="base_api+'/post_content'"
          :show-file-list="false"
          :auto-upload="true"
          :multiple="false"
          :before-upload="beforeContentUpload"
          :on-change="handleContentAccept"
        >
          <img v-if="post_content" :src="post_content" class="avatar">
...
export default {
  ...
  methods: {
    ...
    submitImg() {
      this.$message.info('正在执行... 请稍后(大概需要10秒左右，服务器太垃圾了，属实抱歉)')
      post_style(this.formdata).then(res => {
